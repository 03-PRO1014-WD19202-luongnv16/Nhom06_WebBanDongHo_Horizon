...
<body>
    <div class="sidebar">
        ...
        <div class="items-container">
            ...
            <a href="index.php?act=listvoucher" class="sidebar-items">Quản lý voucher</a>
            <a href="index.php?act=listtaikhoan" class="sidebar-items">Quản lý tài khoản</a>
            <a href="index.php?act=listthongke" class="sidebar-items">Thống kê</a>
        </div>
        <center><div class="logout-button">Thoát</div></center>
    </div>
</body>
</html>