        ...
        <div class="container">  
            <form class="input-form" action="index.php?act=updatetk" method="post" enctype="multipart/form-data">  
                <div class="input-data-text">  
                    <div class="input">  
                        Tên tài khoản<br>  
                        <input class="input-data" type="text" name="user" value="<?php if(isset($user) && ($user != "")) echo $user; ?>">  
                    </div>  
                    <div class="input">  
                        Mật khẩu<br>  
                        <input class="input-data" type="password" name="pass" value="<?php if(isset($pass) && ($pass != "")) echo $pass; ?>">  
                    </div>  
                    <div class="input">  
                        Email<br>  
                        <input class="input-data" type="email" name="email" value="<?php if(isset($email) && ($email != "")) echo $email; ?>">  
                    </div>  
                    <div class="input">  
                        Địa chỉ<br>  
                        <input class="input-data" type="text" name="diachi" value="<?php if(isset($diachi) && ($diachi != "")) echo $diachi; ?>">  
                    </div>  
                </div>  
                <div class="input-data-file">  
                    ...
                    <div class="input">  
                        Tel<br>  
                        <input class="input-data" type="text" name="tel" value="<?php if(isset($tel) && ($tel != "")) echo $tel; ?>">  
                    </div>  
                    <div class="input">  
                        Vai trò<br>  
                        <input class="input-data" type="text" name="role" value="<?php if(isset($role) && ($role != "")) echo $role; ?>">  
                    </div>  
                </div>  
