...
$products = pdo_query("SELECT * FROM sanpham LIMIT 5");
$count=0;

echo '<center><h1 class="title hidden">Những sản phẩm tại Horizon Watch Shop </h1></center><tr></tr><div class="row ">';
...
echo '</div>';
echo '<center><a href="index.php?act=sanpham"><div class="see-more">Xem thêm ?</div></a></center>'; 
