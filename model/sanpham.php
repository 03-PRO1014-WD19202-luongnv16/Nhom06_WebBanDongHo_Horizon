<?php
function insert_sanpham($tensp, $gia_nhap, $gia_chua_giam, $giasp, $soluong, $anhsp, $mota, $id_dm, $date)
{
    $sql = "insert into sanpham(tensp,gia_nhap,gia_chua_giam,giasp,'soluong',anhsp,mota,id_dm,luotxem,date) values('$tensp','$gia_nhap','$gia_chua_giam','$giasp','$soluong','$anhsp','$mota','$id_dm','$date')";
    pdo_execute($sql);
}
